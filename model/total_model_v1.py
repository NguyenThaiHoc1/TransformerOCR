...
class TotalModel(tf.keras.Model):
    def __init__(self, enc_stack_size, dec_stack_size,
        ...
        self.transformer = Transformer(enc_stack_size, d_model, num_heads, d_ff,
                                       self.row_size, self.col_size, vocab_size,
                                       max_pos_encoding=max_seq_leng, rate=0.1)
